...
PARAMETER_LIST = [#'maxGrowthRate','saturationConstant',
                  'cellperGlyMass',
...
VARS_TO_UNITS = {#'maxGrowthRate':'/s',
                #'saturationConstant': r'Mm',
                'cellperGlyMass': '',
...
param_sens_log_unif_bounds = {#'maxGrowthRate': np.log10([1e6, 1e12]), 
                        #'saturationConstant': np.log10([1e-3,1e1]),
                        ...
                        'KmDhaTH': np.log10([1e-1, 1e1]),
                        'VmaxfGlpK': np.log10([1e-2,1e3]) ,
                        'KmGlpKG': np.log10([1e-3,1e-1])}

param_sens_log_norm_bounds = {#'maxGrowthRate': [9,(3/2)**2], 
                        #'saturationConstant': [-1, 1**2],
...
param_sens_bounds = {#'maxGrowthRate': [1e6, 1e12],
                     #'saturationConstant': [1e-3, 1e1],
                     'cellperGlyMass': np.log10([1e4, 1e12]),
