...
def loglik(params,dhaB_dhaT_model,sigma=[2,2,0.1]):
	...
	@param params:
	@param dhaB_dhaT_model:
	@param sigma:
	@return:
	"""
	#CALIBRATION CONSTANT
	if dhaB_dhaT_model.transform_name == 'log_unif_prior':
		bound_a,bound_b = LOG_UNIF_PRIOR_PARAMETERS['scalar']
		scalar = 10**((bound_b - bound_a)*params[0] + bound_a) 
	elif dhaB_dhaT_model.transform_name == 'log_norm_prior':
		scalar = 10**(params[0])
	else:
		scalar= params[0]
...
def test(sigma = [2,2,0.1],transform = "log_unif"):
	...
	file_name = 'MCMC/MCMC_results_data/old_files/adaptive_lambda_0,01_beta_0,05_norm_nsamples_1000_sigma_[2,2,0,2]_date_2021_04_15_17_00_rank_2'
...
def argmaxdensity(argv, arc):
	...
	dhaB_dhaT_model = DhaBDhaTModel(transform=argv[5])
	...
	def initial_param():
		file_name = 'MCMC/MCMC_results_data/old_files/adaptive_lambda_0,01_beta_0,05_norm_nsamples_10_sigma_[2,2,0,2]_date_2021_04_12_21_28_rank_0'
...
def main(argv, arc):
	...
	# set inital starting point
	def initial_param():
		file_name = 'MCMC/MCMC_results_data/old_files/adaptive_lambda_0,01_beta_0,05_norm_nsamples_1000_sigma_[2,2,0,2]_date_2021_04_15_00_21_rank_0'
		param_start = load_obj(file_name)[-1]
		return param_start
